...
void LED_Matrix() {
	...
	if (x >= 5000) {
		LED_Toggle(15);
		delay(50);
		UART_Write_String("Front-side Tilted alert!!\n");
	} else if (x <= -5000) {
		LED_Toggle(13);
		delay(50);
		UART_Write_String("Back-side Tilted alert!!\n");
	}
	...
	if (y >= 5000) {
		LED_Toggle(12);
		delay(50);
		UART_Write_String("Right-side Tilted alert!!\n");
	} else if (y <= -5000) {
		LED_Toggle(14);
		delay(50);
		UART_Write_String("Left-side Tilted alert!!\n");
	}
}
